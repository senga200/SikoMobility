...
function Footer() {
  return (
    <div className="absolute w-full top-[2500px] bg-gray-200 flex flex-col items-center box-border text-sm ">
      <div className="w-[1280px] flex flex-col items-start justify-start py-8 px-4 box-border gap-[32px] mx-auto relative border-red-500">
        ...
        <div className="relative box-border w-[1248px] h-px overflow-hidden shrink-0 border-t-[1px] border-solid border-darkslategray" />
