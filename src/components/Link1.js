const Link1 = () => {
  return (
    <div className="rounded-lg w-[405px] h-[860px] flex flex-col items-start justify-start relative min-w-[256px] min-h-[256px] text-left text-4xl text-white font-nunito-sans">
      <img
      ...
      />
      <div className="my-0 mx-[!important] absolute h-full w-full top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-lg bg-gray-300 flex flex-col items-start justify-end pt-[767px] pb-6 pr-px pl-0 box-border gap-[37px] z-[1]">
